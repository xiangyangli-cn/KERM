...
class Seq2SeqAgent(BaseAgent):
    ...
    def __init__(self, args, env, rank=0):
        ...
        update_param_name = ['knowledge_proj','crop_proj','instruction_proj','history_proj','fusion_proj','cross_vision_knowledge','cross_history_knowledge','fusion_layer_norm','final_ffn','no_history_embedding','final_layer_norm']
        ...
        optimizer_grouped_parameters = [
            {'params': [p for n, p in update_param], 'lr': self.args.lr * 10. },
            {'params': [p for n, p in freeze_param], 'lr': self.args.lr * 1e-3 }
        ]
